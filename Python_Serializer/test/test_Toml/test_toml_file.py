...
class TestTomlFileSerializer(unittest.TestCase):

    def test_int_serialization_to_file(self):
        object_to_serialize = test_object.integer
        serializer.dump(object_to_serialize, 'test.toml')
        object_after_deserialize = serializer.load('test.toml')
    ...
    def test_tuple_serialization_to_file(self):
        object_to_serialize = test_object.tuple_for_toml
        serializer.dump(object_to_serialize, 'test.toml')
        object_after_deserialize = serializer.load('test.toml')
        self.assertEqual(object_to_serialize, object_after_deserialize)
    ...
    def test_list_serialization_to_file(self):
        object_to_serialize = test_object.list_for_toml
        serializer.dump(object_to_serialize, 'test.toml')
        object_after_deserialize = serializer.load('test.toml')
        self.assertEqual(object_to_serialize, object_after_deserialize)
